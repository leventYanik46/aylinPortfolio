...
interface Props {
    ...
    education_description?: PropRichTextDataParsed;
                ...
                <div className="relative z-10">
                    ...
                    <div className="mt-6 lg:mt-8">
                        <div className="flex items-center mb-[14px]">
                            <div className="w-1.5 h-1.5 bg-appText rounded-full mr-2 lg:w-2.5 lg:h-2.5 lg:mr-4" />
                        ...
                        {education_description && (
                            <ContentManager
                                items={education_description.nodes}
                                className="text-sm leading-[1.4] tracking-[-0.41px] text-appGray-400 mb-4 lg:text-base lg:leading-[1.4]"
                            />
                        )}
